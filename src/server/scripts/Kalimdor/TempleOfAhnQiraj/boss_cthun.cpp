...
public:
    ...
    struct eye_of_cthunAI : public Scripted_NoMovementAI
    {
        ...
        void Reset()
        {
            ...
            //Reset Phase
            if(pInstance)
                pInstance->SetData(DATA_CTHUN_PHASE, PHASE_NOT_STARTED);
        ...
        void EnterCombat(Unit* /*pWho*/)
        {
            DoZoneInCombat();
            if(pInstance)
                pInstance->SetData(DATA_CTHUN_PHASE, PHASE_EYE_GREEN_BEAM);
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            uint32 currentPhase = pInstance->GetData(DATA_CTHUN_PHASE);
            ...
            switch(currentPhase)
            {
                case PHASE_EYE_GREEN_BEAM:
                    ...
                    {
                        //Switch to Dark Beam
                        pInstance->SetData(DATA_CTHUN_PHASE, PHASE_EYE_RED_BEAM);
        ...
        void DamageTaken(Unit* /*done_by*/, uint32 &damage)
        {
            ...
            switch(pInstance->GetData(DATA_CTHUN_PHASE))
            {
                ...
                case PHASE_EYE_RED_BEAM:
                    ...
                    pInstance->SetData(DATA_CTHUN_PHASE, PHASE_CTHUN_TRANSITION);
                    ...
                    me->RemoveAllAuras();
                    break;
                case PHASE_CTHUN_DONE:  //Allow death here
                    return;
                default:                //Prevent death in these phases
                    damage = 0;
                    return;
            }
        }
...
public:
    ...
    struct cthunAI : public Scripted_NoMovementAI
    {
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            switch(currentPhase)
            {
                ...
                case PHASE_CTHUN_TRANSITION:
                    ...
                    {
                        //Switch
                        pInstance->SetData(DATA_CTHUN_PHASE, PHASE_CTHUN_STOMACH);
                ...
                case PHASE_CTHUN_STOMACH:
                    ...
                    {
                        pInstance->SetData(DATA_CTHUN_PHASE, PHASE_CTHUN_WEAK);
        ...
        {
            if(pInstance)
                pInstance->SetData(DATA_CTHUN_PHASE, PHASE_CTHUN_DONE);
        }
...
public:
    ...
    {
        flesh_tentacleAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature)
        {
            SetCombatMovement(false);
        }
