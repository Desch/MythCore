...
public:
    ...
    struct npc_arthasAI : public npc_escortAI
    {
        ...
        {
            if(Creature* pCreature = me->GetCreature(*me, pInstance->GetData64(DATA_CRIER)))
            {
                int32 textId = 0;
                switch(waveNumber)
                {
                ...
                if(textId < 0)
                    pCreature->YellToZone(textId, LANG_UNIVERSAL, 0);
            }
        }
    };
};
...
class npc_crate_helper : public CreatureScript
{
    public:
        ...
        {
            npc_crate_helperAI(Creature* pCreature) : NullCreatureAI(pCreature)
            {
                _marked = false;
            }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new npc_crate_helperAI(pCreature);
        }
};
