...
hyjalAI::hyjalAI(Creature* pCreature) : npc_escortAI(pCreature), Summons(me)
{
...
void hyjalAI::DoOverrun(uint32 faction, const uint32 diff)
{
    ...
    switch(faction)
    {
        case 0://alliance
            ...
            {
                uint8 r = rand()%4;
                if(Creature* pUnit = me->SummonCreature(GHOUL, AllianceBase[r][0]+irand(-15, 15), AllianceBase[r][1]+irand(-15, 15), AllianceBase[r][2], 0, TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
            ...
            {
                uint8 r = rand()%4;
                if(Creature* pUnit = me->SummonCreature(ABOMINATION, AllianceBase[r][0]+irand(-15, 15), AllianceBase[r][1]+irand(-15, 15), AllianceBase[r][2], 0, TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
                    CAST_AI(hyjal_trashAI, pUnit->AI())->faction = Faction;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->IsOverrun = true;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->OverrunType = i;
            ...
            {
                if(Creature* pUnit = me->SummonCreature(GARGOYLE, AllianceOverrunGargPos[i][0], AllianceOverrunGargPos[i][1], AllianceOverrunGargPos[i][2], AllianceOverrunGargPos[i][3], TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
        ...
        case 1://horde
            ...
            {
                if(Creature* pUnit = me->SummonCreature(GIANT_INFERNAL, InfernalSPWP[i][0], InfernalSPWP[i][1], InfernalSPWP[i][2], InfernalSPWP[i][3], TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
            ...
            {
                uint8 r = rand()%4;
                if(Creature* pUnit = me->SummonCreature(GHOUL, HordeBase[r][0]+irand(-15, 15), HordeBase[r][1]+irand(-15, 15), HordeBase[r][2], 0, TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
                    CAST_AI(hyjal_trashAI, pUnit->AI())->faction = Faction;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->IsOverrun = true;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->OverrunType = i;
            ...
            {
                uint8 r = rand()%4;
                if(Creature* pUnit = me->SummonCreature(ABOMINATION, HordeBase[r][0]+irand(-15, 15), HordeBase[r][1]+irand(-15, 15), HordeBase[r][2], 0, TEMPSUMMON_MANUAL_DESPAWN, 2*60*1000))
                {
                    CAST_AI(hyjal_trashAI, pUnit->AI())->faction = Faction;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->IsOverrun = true;
                    CAST_AI(hyjal_trashAI, pUnit->AI())->OverrunType = i;
