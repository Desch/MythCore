...
public:
    ...
    {
        npc_portal_eoeAI(Creature* pCreature): ScriptedAI(pCreature)
        {
...
public:
    ...
    {
        npc_hover_diskAI(Creature* pCreature) : npc_escortAI(pCreature)
        {
...
public:
    ...
    {
        npc_wyrmrest_skytalonAI(Creature* pCreature) : NullCreatureAI(pCreature)
        {
            _instance = pCreature->GetInstanceScript();
...
class achievement_denyin_the_scion : public AchievementCriteriaScript
{
    public:
        ...
        {
            if(Unit* pDisc = pSource->GetVehicleBase())
                if(pDisc->GetEntry() == NPC_HOVER_DISK_CASTER || pDisc->GetEntry() == NPC_HOVER_DISK_MELEE)
                    return true;
            return false;
        }
};
