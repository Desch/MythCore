...
public:
    ...
    {
        npc_khunok_the_behemothAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_trapped_mammoth_calfAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_magmoth_crusherAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_valiance_keep_cannoneerAI(Creature* pCreature) : ScriptedAI(pCreature) { }
