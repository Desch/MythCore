...
#define EMOTE_LEVIATHAN                         "Leviathan MK II commence à lancer Explosion de plasma!"
...
class npc_mimiron_flame_spread : public CreatureScript
{
    public:
        ...
        {
            npc_mimiron_flame_spreadAI(Creature* pCreature): ScriptedAI(pCreature)
            {
...
class achievement_firefighter : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* player, Unit* /*pTarget*/)
        {
            if(!player)
                return false;
