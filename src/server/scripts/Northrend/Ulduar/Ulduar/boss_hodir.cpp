...
class npc_flash_freeze : public CreatureScript
{
    public:
        ...
        {
            npc_flash_freezeAI(Creature* pCreature): ScriptedAI(pCreature)
            {
...
class npc_ice_block : public CreatureScript
{
    public:
        ...
        {
            npc_ice_blockAI(Creature* pCreature): ScriptedAI(pCreature)
            {
                instance = me->GetInstanceScript();
                me->SetDisplayId(me->GetCreatureInfo()->Modelid2);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_DISABLE_MOVE | UNIT_FLAG_STUNNED | UNIT_FLAG_PACIFIED);
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new npc_ice_blockAI(pCreature);
        }
};
...
class npc_snowpacked_icicle : public CreatureScript
{
    public:
        ...
        {
            npc_snowpacked_icicleAI(Creature* pCreature): ScriptedAI(pCreature)
            {
                me->SetDisplayId(me->GetCreatureInfo()->Modelid2);
...
class npc_hodir_mage : public CreatureScript
{
    public:
        ...
        {
            npc_hodir_mageAI(Creature* pCreature): ScriptedAI(pCreature), summons(me)
            {
                instance = me->GetInstanceScript();
            }
...
class npc_toasty_fire : public CreatureScript
{
    public:
        ...
        {
            npc_toasty_fireAI(Creature* pCreature): ScriptedAI(pCreature)
            {
                me->SetDisplayId(me->GetCreatureInfo()->Modelid2);
            }
