...
class boss_flame_leviathan_defense_turret : public CreatureScript
{
    public:
        ...
        {
            boss_flame_leviathan_defense_turretAI(Creature* pCreature) : TurretAI(pCreature) { }
...
class npc_mechanolift : public CreatureScript
{
    public:
        ...
        {
            npc_mechanoliftAI(Creature* pCreature) : PassiveAI(pCreature)
            {
...
class npc_pool_of_tar : public CreatureScript
{
    public:
        ...
        {
            npc_pool_of_tarAI(Creature* pCreature): ScriptedAI(pCreature)
            {
        ...
        struct npc_colossusAI : public ScriptedAI
        {
            ...
            void JustDied(Unit* /*pWho*/)
            {
                if(me->GetHomePosition().GetPositionX() > 150.0)
                    pInstance->SetData(DATA_COLOSSUS, 1);
            }
...
{
    public:
        npc_lorekeeper() : CreatureScript("npc_ulduar_lorekeeper") { }
...
class achievement_three_car_garage_demolisher : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* pSource, Unit* /*pTarget*/)
        {
            ...
            {
                if(pCreature_Vehice->GetEntry() == VEHICLE_DEMOLISHER)
                    return true;
            }
...
class achievement_three_car_garage_chopper : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* pSource, Unit* /*pTarget*/)
        {
            if(Creature* pCreature_Vehice = pSource->GetVehicleCreatureBase())
            {
                if(pCreature_Vehice->GetEntry() == VEHICLE_CHOPPER)
                    return true;
            }
...
class achievement_three_car_garage_siege : public AchievementCriteriaScript
{
    public:
        ...
        bool OnCheck(Player* pSource, Unit* /*pTarget*/)
        {
            if(Creature* pCreature_Vehice = pSource->GetVehicleCreatureBase())
            {
                if(pCreature_Vehice->GetEntry() == VEHICLE_SIEGE)
                    return true;
            }
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            ...
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_SHUTOUT))
                    return true;
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            if(!pTarget)
                return false;
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_UNBROKEN))
                    return true;
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            if(!pTarget)
                return false;
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_ORBIT_ACHIEVEMENTS) >= 1)
                    return true;
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            if(!pTarget)
                return false;
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_ORBIT_ACHIEVEMENTS) >= 2)
                    return true;
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            if(!pTarget)
                return false;
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_ORBIT_ACHIEVEMENTS) >= 3)
                    return true;
    ...
    public:
        ...
        bool OnCheck(Player* /*pSource*/, Unit* pTarget)
        {
            if(!pTarget)
                return false;
            if(Creature* pCreature = pTarget->ToCreature())
                if(pCreature->AI()->GetData(DATA_ORBIT_ACHIEVEMENTS) == 4)
                    return true;
...
class spell_pursue : public SpellScriptLoader
{
    public:
        ...
        class spell_pursue_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnUnitTargetSelect += SpellUnitTargetFn(spell_pursue_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_AREA_ENEMY_SRC);
                OnUnitTargetSelect += SpellUnitTargetFn(spell_pursue_SpellScript::FilterTargetsSubsequently, EFFECT_1, TARGET_UNIT_AREA_ENEMY_SRC);
