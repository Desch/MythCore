...
class npc_iron_construct : public CreatureScript
{
    public:
        ...
        {
            npc_iron_constructAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript())
            {
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetUlduarAI<npc_iron_constructAI>(pCreature);
        }
};
...
class npc_scorch_ground : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetUlduarAI<npc_scorch_groundAI>(pCreature);
        }
};
