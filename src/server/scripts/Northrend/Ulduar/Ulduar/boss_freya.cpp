...
#define SPELL_ACHIEVEMENT_CHECK     65074
        ...
        void JustDied(Unit* /*pKiller*/)
        {
            ...
            for(uint8 n = 0; n < 3; ++n)
            {
                ...
                if(Elder[n] && Elder[n]->isAlive())
                {
                    ...
                    Elder[n]->DespawnOrUnsummon(10000);;
                }
            }
        }
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetUlduarAI<boss_elder_brightleafAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetUlduarAI<boss_elder_stonebarkAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetUlduarAI<boss_elder_ironbranchAI>(pCreature);
    }
};
