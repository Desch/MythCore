...
public:
    ...
    {
        mob_azure_saboteurAI(Creature* pCreature) : npc_escortAI(pCreature)
        {
            pInstance           = pCreature->GetInstanceScript();
...
public:
    ...
    {
        npc_teleportation_portalAI(Creature* pCreature) : ScriptedAI(pCreature), listOfMobs(me)
        {
            pInstance = pCreature->GetInstanceScript();
...
{
    violet_hold_trashAI(Creature* pCreature) : npc_escortAI(pCreature)
    {
        pInstance = pCreature->GetInstanceScript();
        bHasGotMovingPoints = false;
        if(pInstance)
...
public:
    ...
    {
        mob_azure_invaderAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_binderAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_mage_slayerAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_raiderAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_stalkerAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_spellbreakerAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
             pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_captainAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_azure_sorcerorAI(Creature* pCreature) : violet_hold_trashAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
