    ...
    struct instance_ruby_sanctum_InstanceMapScript : public InstanceScript
    {
        ...
        void SetData(uint32 uiType, uint32 uiData)
        {
            switch(uiType)
            {
                ...
                case TYPE_RAGEFIRE:     m_auiEncounter[uiType] = uiData; OpenFlameWallsDoors(); break;
                case TYPE_BALTHARUS:    m_auiEncounter[uiType] = uiData; OpenFlameWallsDoors(); break;
                ...
                case TYPE_HALION: m_auiEncounter[uiType] = uiData;
                    ...
                    break;
                case TYPE_HALION_EVENT:     m_auiHalionEvent = uiData;  break;
                case TYPE_EVENT_TIMER:      m_auiEventTimer = uiData;   break;
                case DATA_ORB_DIRECTION:    m_auiOrbDirection = uiData; break;
                case DATA_ORB_N:            m_auiOrbNState = uiData;    break;
                case DATA_ORB_S:            m_auiOrbSState = uiData;    break;
                case TYPE_COUNTER:
            ...
            if(uiType < MAX_ENCOUNTERS && uiData == DONE)
            {
                OUT_SAVE_INST_DATA;
