...
public:
    ...
    {
        boss_jedoga_shadowseekerAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
...
public:
    ...
    {
        mob_jedoga_initiandAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        npc_jedogas_aufseher_triggerAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
            bRemoved = false;
            bRemoved2 = false;
