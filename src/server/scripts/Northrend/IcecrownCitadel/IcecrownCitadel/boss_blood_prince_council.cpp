...
public:
    ...
    {
        return GetIcecrownCitadelAI<boss_blood_council_controllerAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<boss_prince_kelesethAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<boss_prince_taldaramAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<boss_prince_valanarAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_blood_queen_lana_thelAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_ball_of_flameAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript())
        {
            _despawnTimer = 0;
            me->ApplySpellImmune(0, IMMUNITY_EFFECT, SPELL_EFFECT_KNOCK_BACK, true);
            me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_GRIP, true);
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_ball_of_flameAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_kinetic_bombAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_dark_nucleusAI>(pCreature);
    }
};
