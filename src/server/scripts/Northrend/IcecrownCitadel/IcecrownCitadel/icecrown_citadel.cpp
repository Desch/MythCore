...
class npc_highlord_tirion_fordring_lh : public CreatureScript
{
    public:
        ...
        {
            npc_highlord_tirion_fordringAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
        ...
        {
            return GetIcecrownCitadelAI<npc_highlord_tirion_fordringAI>(pCreature);
        }
};
...
class npc_rotting_frost_giant : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_rotting_frost_giantAI>(pCreature);
        }
};
...
class npc_frost_freeze_trap : public CreatureScript
{
    public:
        ...
        {
            npc_frost_freeze_trapAI(Creature* pCreature): Scripted_NoMovementAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_frost_freeze_trapAI>(pCreature);
        }
};
...
class boss_sister_svalna : public CreatureScript
{
    public:
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<boss_sister_svalnaAI>(pCreature);
        }
};
...
class npc_crok_scourgebane : public CreatureScript
{
    public:
        ...
        {
            npc_crok_scourgebaneAI(Creature* pCreature) : npc_escortAI(pCreature),
                _instance(pCreature->GetInstanceScript()), _respawnTime(pCreature->GetRespawnDelay()),
                _corpseDelay(pCreature->GetCorpseDelay())
            {
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_crok_scourgebaneAI>(pCreature);
        }
};
...
{
    public:
        npc_argent_captainAI(Creature* pCreature): ScriptedAI(pCreature), Instance(pCreature->GetInstanceScript()), _firstDeath(true)
        {
...
class npc_captain_arnath : public CreatureScript
{
    public:
        ...
        {
            npc_captain_arnathAI(Creature* pCreature) : npc_argent_captainAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_captain_arnathAI>(pCreature);
        }
};
...
class npc_captain_brandon : public CreatureScript
{
    public:
        ...
        {
            npc_captain_brandonAI(Creature* pCreature) : npc_argent_captainAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_captain_brandonAI>(pCreature);
        }
};
...
class npc_captain_grondel : public CreatureScript
{
    public:
        ...
        {
            npc_captain_grondelAI(Creature* pCreature) : npc_argent_captainAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_captain_grondelAI>(pCreature);
        }
};
...
class npc_captain_rupert : public CreatureScript
{
    public:
        ...
        {
            npc_captain_rupertAI(Creature* pCreature) : npc_argent_captainAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_captain_rupertAI>(pCreature);
        }
};
...
class npc_frostwing_vrykul : public CreatureScript
{
    public:
        ...
        {
            npc_frostwing_vrykulAI(Creature* pCreature) : SmartAI(pCreature) { }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new npc_frostwing_vrykulAI(pCreature);
        }
};
...
class npc_impaling_spear : public CreatureScript
{
    public:
        ...
        {
            npc_impaling_spearAI(Creature* pCreature) : CreatureAI(pCreature) { }
