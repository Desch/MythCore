...
public:
    ...
    {
        return GetIcecrownCitadelAI<boss_rotfaceAI>(pCreature);
    }
};
...
public:
    ...
    struct npc_little_oozeAI : public ScriptedAI
    {
        ...
        void IsSummonedBy(Unit* pSummoner)
        {
            ...
            me->AddThreat(pSummoner, 500000.0f);
        }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_little_oozeAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_big_oozeAI(Creature* pCreature): ScriptedAI(pCreature), instance(pCreature->GetInstanceScript()){ }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_big_oozeAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_precious_iccAI(Creature* pCreature): ScriptedAI(pCreature), _summons(me)
        {
            _instance = pCreature->GetInstanceScript();
        }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_precious_iccAI>(pCreature);
    }
};
