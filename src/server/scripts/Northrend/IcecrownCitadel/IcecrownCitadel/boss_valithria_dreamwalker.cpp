...
public:
    ...
    {
        boss_valithria_dreamwalkerAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()), _portalCount(RAID_MODE<uint32>(3, 8, 3, 8)) { }
          void InitializeAI()
        {
        ...
        void HealReceived(Unit* /*healer*/, uint32& heal)
        {
            ...
            // Do not recieve heal when Lana not die.
            if(_instance->GetBossState(DATA_BLOOD_QUEEN_LANA_THEL) != DONE)
            {
                heal = 0;
                return;
            }
    ...
    {
        return GetIcecrownCitadelAI<boss_valithria_dreamwalkerAI>(pCreature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_green_dragon_combat_triggerAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_the_lich_king_controllerAI(Creature* pCreature): ScriptedAI(pCreature),
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return new npc_the_lich_king_controllerAI(pCreature);
    }
};
...
public:
    ...
    {
        npc_risen_archmageAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_risen_archmageAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_blazing_skeletonAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_blazing_skeletonAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_suppresserAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
        ...
        void UpdateAI(uint32 const diff)
        {
            ...
            if(Unit* pVictim = me->getVictim())
                if(pVictim->GetEntry() != NPC_VALITHRIA_DREAMWALKER)
                    DoMeleeAttackIfReady();
        }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_suppresserAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_blistering_zombieAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_blistering_zombieAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_gluttonous_abominationAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
          void Reset()
        {
            _events.Reset();
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_gluttonous_abominationAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_dream_portalAI(Creature* pCreature) : CreatureAI(pCreature),
            _used(false) { }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_dream_portalAI>(pCreature);
    }
};
...
public:
    ...
    {
        npc_dream_cloudAI(Creature* pCreature): ScriptedAI(pCreature), _instance(pCreature->GetInstanceScript()) { }
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return GetIcecrownCitadelAI<npc_dream_cloudAI>(pCreature);
    }
};
