...
public:
    ...
    {
        npc_ghostly_priestAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_phantom_mageAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_shadowy_mercenaryAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_spectral_footmanAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_tortured_riflemanAI(Creature* pCreature) : ScriptedAI(pCreature) { }
