...
public:
    ...
    {
        npc_sylvanas_fosAI(Creature* pCreature): ScriptedAI(pCreature)
        {
...
public:
    ...
    {
        npc_jaina_fosAI(Creature* pCreature): ScriptedAI(pCreature)
        {
            pInstance = me->GetInstanceScript();
            me->SetFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);
        }
...
public:
    ...
    {
        mob_spiteful_apparitionAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_spectral_wardenAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soulguard_watchmanAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soulguard_reaperAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soulguard_bonecasterAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soulguard_animatorAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soulguard_adeptAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
public:
    ...
    {
        mob_soul_horrorAI(Creature* pCreature): ScriptedAI(pCreature) { }
