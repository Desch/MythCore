...
public:
    ...
    {
        boss_entropiusAI(Creature* pCreature) : ScriptedAI(pCreature), Summons(me)
        {
...
public:
    ...
    {
        boss_muruAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature), Summons(me)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        npc_muru_portalAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature), Summons(me)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        npc_dark_fiendAI(Creature* pCreature) : ScriptedAI(pCreature) { }
...
public:
    ...
    {
        npc_void_sentinelAI(Creature* pCreature) : ScriptedAI(pCreature){ }
...
public:
    ...
    {
        npc_blackholeAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
            pInstance = pCreature->GetInstanceScript();
        }
