...
public:
    ...
    {
        boss_kalecgos_kjAI(Creature* pCreature) : ScriptedAI(pCreature)
        {
...
public:
    ...
    {
        mob_kiljaeden_controllerAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature), summons(me)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        boss_kiljaedenAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature), summons(me)
        {
            pInstance = pCreature->GetInstanceScript();
        }
...
public:
    ...
    {
        mob_armageddonAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature) { }
...
public:
    ...
    {
        mob_sinster_reflectionAI(Creature* pCreature) : ScriptedAI(pCreature) { }
