...
class mob_janalai_firebomb : public CreatureScript
{
    public:
        ...
        {
            mob_janalai_firebombAI(Creature* pCreature) : ScriptedAI(pCreature){ }
...
class mob_janalai_hatchling : public CreatureScript
{
    public:
        ...
        {
            mob_janalai_hatchlingAI(Creature* pCreature) : ScriptedAI(pCreature)
            {
                pInstance = pCreature->GetInstanceScript();
            }
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return new mob_janalai_hatchlingAI(pCreature);
        }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return new mob_janalai_eggAI(pCreature);
    }

    struct mob_janalai_eggAI : public ScriptedAI
    {
        mob_janalai_eggAI(Creature* pCreature): ScriptedAI(pCreature){ }
