...
public:
    ...
    {
        mob_water_elementalAI(Creature* pCreature) : ScriptedAI(pCreature) { }
    ...
    {
        return new mob_water_elementalAI(pCreature);
    }
};
...
public:
    ...
    {
        boss_balindaAI(Creature* pCreature) : ScriptedAI(pCreature), Summons(me) { }
