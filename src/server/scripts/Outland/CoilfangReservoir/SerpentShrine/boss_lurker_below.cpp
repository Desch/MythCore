...
public:
    ...
    {
        boss_the_lurker_belowAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature), Summons(me)
        {
...
public:
    ...
    {
        mob_coilfang_ambusherAI(Creature* pCreature) : Scripted_NoMovementAI(pCreature) { }
