...
public:
    ...
    {
        boss_nexusprince_shaffarAI(Creature* pCreature) : ScriptedAI(pCreature), summons(me) { HasTaunted = false; }
...
public:
    ...
    {
        mob_ethereal_apprenticeAI(Creature* pCreature) : ScriptedAI(pCreature) { }
