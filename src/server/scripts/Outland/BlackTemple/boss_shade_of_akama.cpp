...
public:
    ...
    {
        mob_ashtongue_channelerAI(Creature* pCreature) : ScriptedAI(pCreature) {ShadeGUID = 0;}
...
public:
    ...
    {
        mob_ashtongue_sorcererAI(Creature* pCreature) : ScriptedAI(pCreature) {ShadeGUID = 0;}
...
public:
    ...
    {
        boss_shade_of_akamaAI(Creature* pCreature) : ScriptedAI(pCreature), summons(me)
        {
...
public:
    ...
    {
        npc_akamaAI(Creature* pCreature) : ScriptedAI(pCreature), summons(me)
        {
            ShadeHasDied = false;
            StartCombat = false;
            pInstance = pCreature->GetInstanceScript();
