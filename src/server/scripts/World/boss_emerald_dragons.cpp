...
{
    emerald_dragonAI(Creature* pCreature) : WorldBossAI(pCreature) { }
...
class npc_dream_fog : public CreatureScript
{
    public:
        ...
        {
            npc_dream_fogAI(Creature* pCreature): ScriptedAI(pCreature) { }
...
class boss_ysondre : public CreatureScript
{
    public:
        ...
        {
            boss_ysondreAI(Creature* pCreature) : emerald_dragonAI(pCreature) { }
...
class boss_lethon : public CreatureScript
{
    public:
        ...
        {
            boss_lethonAI(Creature* pCreature) : emerald_dragonAI(pCreature) { }
...
class boss_emeriss : public CreatureScript
{
    public:
        ...
        {
            boss_emerissAI(Creature* pCreature) : emerald_dragonAI(pCreature) { }
...
class boss_taerar : public CreatureScript
{
    public:
        ...
        {
            boss_taerarAI(Creature* pCreature) : emerald_dragonAI(pCreature)
            {
                _stage = 1;
                _shades = 0;
                _banished = false;
