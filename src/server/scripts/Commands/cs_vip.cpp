    ...
    public:
        ...
        ChatCommand* GetCommands() const
        {
            static ChatCommand vipteleCommandTable[] =
            {
                ...
                { "zoneshop",         SEC_VIP,        false,    &HandleVipTelezoneshopCommand,     "", NULL },
        ...
        static bool HandleVipTelezoneshopCommand(ChatHandler* handler, const char * /*args*/)
        {
            Player* _player = handler->GetSession()->GetPlayer();
            ...
            _player->TeleportTo(571, 5778.92f, 607.65f, 565.30f, 4.04f);
