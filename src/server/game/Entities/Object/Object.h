...
#define DEFAULT_VISIBILITY_INSTANCE 150.0f  // default visible distance in instances, 120 yards
#define DEFAULT_VISIBILITY_BGARENAS 230.0f  // default visible distance in BG/Arenas, 180 yards
...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        bool IsWithinDist(WorldObject const* pWO, float dist2compare, bool is3D = true) const
            { return this && pWO && _IsWithinDist(pWO, dist2compare, is3D); }
        bool IsWithinDistInMap(WorldObject const* pWO, float dist2compare, bool is3D = true) const
            { return this && pWO && IsInMap(pWO) && _IsWithinDist(pWO, dist2compare, is3D); }
