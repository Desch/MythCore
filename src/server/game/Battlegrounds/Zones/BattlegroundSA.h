...
class BattlegroundSA : public Battleground
{
    ...
    public:
        bool CriteriaForAchievement2200;
        void CriteriaForAchievement2200Check(Player* pPlayer)
        {
            if(CriteriaForAchievement2200)
                pPlayer->Achievement2200Check();
        }
        bool CriteriaForAchievement1757;
        void CriteriaForAchievement1757Check(Player* pPlayer)
        {
            if(CriteriaForAchievement1757)
                pPlayer->Achievement1757Check();
        }
};
