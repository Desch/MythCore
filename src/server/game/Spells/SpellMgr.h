...
inline bool IsSealSpell(SpellEntry const* pSpellInfo)
{
    //Collection of all the seal family flags. No other paladin spell has any of those.
    return pSpellInfo->SpellFamilyName == SPELLFAMILY_PALADIN &&
        (pSpellInfo->SpellFamilyFlags[1] & 0x26000C00
      || pSpellInfo->SpellFamilyFlags[0] & 0x0A000000);
}
