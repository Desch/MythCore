...
namespace nsNpcTel
{
    // Différent types de permissions possible pour les check
    enum Flag
    {
        FLAG_TEAM       = 0,
        FLAG_GUILD      = 1,
    ...
    // Different paramètre de FLAG Possible (à retravailler selon les besoin)
    enum
    {
        TEAM_ALL        = 0,
        TEAM_ALLIANCE   = 1,
    ...
    // Class pour la gestion des destinations et des catégories
    class CatDest
    {
      public:
    ...
    class Page
    {
      protected:
        ...
        // Class de gestion pour les instances
        class Instance
        {
          public:
    ...
    // Vérification de l'intégrité des données (Pas sur que cela soit prit en compte, à vérifier)
...
// Chargement du script du NPC téléporteur.
