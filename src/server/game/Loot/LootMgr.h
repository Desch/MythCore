...
typedef std::set<uint32> AlreadyLootedPlayersSet;
...
struct LootItem
{
    ...
    AlreadyLootedPlayersSet alreadyLootedGUIDs;
    uint8   count             : 8;
    bool    is_looted         : 1;
    bool    is_blocked        : 1;
    ...
    void AddAlreadyLootedPlayer(Player const* player);
    AlreadyLootedPlayersSet const&  GetAlreadyLootedPlayers() const { return alreadyLootedGUIDs; }
};
...
struct Loot
{
    ...
    void generateMoneyLoot(uint32 minAmount, uint32 maxAmount, bool IsPremium);
