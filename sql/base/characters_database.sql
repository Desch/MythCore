...
ALTER TABLE `character_queststatus`
    ADD COLUMN `itemcount5` SMALLINT(5) UNSIGNED DEFAULT 0 NOT NULL AFTER `itemcount4`;
ALTER TABLE `character_queststatus`
    ADD COLUMN `itemcount6` SMALLINT(5) UNSIGNED DEFAULT 0 NOT NULL AFTER `itemcount5`;
